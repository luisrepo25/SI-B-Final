    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departamento', models.CharField(blank=True, help_text='Departamento principal del paquete turístico', max_length=100, null=True)),
                ('ciudad', models.CharField(blank=True, help_text='Ciudad principal del paquete turístico', max_length=100, null=True)),
                ('tipo_destino', models.CharField(blank=True, choices=[('Cultural', 'Cultural'), ('Natural', 'Natural'), ('Aventura', 'Aventura'), ('Rural', 'Rural'), ('Urbano', 'Urbano')], help_text='Tipo de destino turístico', max_length=50, null=True)),
